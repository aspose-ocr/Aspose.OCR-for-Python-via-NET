![PyPI](https://img.shields.io/pypi/v/aspose-ocr-python-net) ![PyPI](https://img.shields.io/pypi/dm/aspose-ocr-python-net) ![GitHub](https://img.shields.io/github/license/aspose-ocr/Aspose.OCR-for-Python-via-NET)
